...
describe('GameEngine', () => {
    ...
    it('should apply weather effects on yield and soil', () => {
        ...
        // Test Drought
        const roundDrought = GameEngine.calculateRound(2, prevRound, decision, { weather: 'Drought', vermin: 'None' }, 1000);
    ...
    it('should apply vermin effects and pest control', () => {
        ...
        const roundPests = GameEngine.calculateRound(2, prevRound, decisionNoPestControl, { weather: 'Normal', vermin: 'Pests' }, 1000);
        ...
        const roundPesticide = GameEngine.calculateRound(2, prevRound, decisionPesticide, { weather: 'Normal', vermin: 'Pests' }, 1000);
