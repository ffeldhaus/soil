  ...
  template: `
    <div class="min-h-screen bg-gray-900 text-white font-sans relative flex flex-col overflow-x-hidden">
      ...
      <div class="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 py-12">
        ...
        <!-- General Section -->
        <section
          class="mb-20 bg-gray-900/80 backdrop-blur-md p-8 sm:p-12 rounded-3xl border border-gray-700 shadow-2xl"
        >
        ...
        <div class="space-y-12">
          <div
            *ngFor="let crop of crops"
            class="bg-gray-900/90 backdrop-blur-md p-6 sm:p-10 rounded-[2.5rem] border border-gray-700 shadow-2xl group break-inside-avoid"
          >
            <div class="flex flex-col lg:flex-row gap-10 items-start">
              <!-- Crop Image & Title -->
              <div class="w-full lg:w-1/3">
                <div
                  class="aspect-square rounded-3xl overflow-hidden shadow-2xl mb-6 border-4 border-gray-800 group-hover:border-emerald-500/50 transition-all duration-500"
                >
                  <img
                    [src]="'assets/images/' + crop.image"
                    [alt]="'crop.' + crop.id.toLowerCase() | transloco"
                    class="w-full h-full object-cover"
                  />
                </div>
                <h3 class="text-4xl font-black text-white mb-4 tracking-tight">
                  {{ 'crop.' + crop.id.toLowerCase() | transloco }}
                </h3>

                <!-- Pest Badge -->
                <div class="flex flex-col gap-2">
                  <span class="text-[10px] font-bold text-gray-500 uppercase tracking-widest">{{
                    'pest.label' | transloco
                  }}</span>
                  <div class="flex items-center gap-3 bg-red-900/20 border border-red-500/30 p-3 rounded-2xl">
                    <div
                      class="w-10 h-10 rounded-xl bg-red-600 flex items-center justify-center text-white shrink-0 shadow-lg"
                    >
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        class="h-6 w-6"
              ...
              <div class="w-full lg:w-2/3 space-y-8">
                ...
                <div class="bg-black/40 p-6 rounded-3xl border border-white/5">
                  <h4 class="text-[10px] font-bold text-gray-500 uppercase tracking-widest mb-6">
                    {{ 'manual.crops.rotation' | transloco }}
                  </h4>
                  <div class="flex flex-col gap-8">
                    <div class="flex flex-col gap-3">
                      <div class="flex flex-wrap gap-2 items-center justify-center lg:justify-start">
                        ...
                        <!-- Current Crop -->
                        <div
                          class="w-16 h-16 rounded-2xl bg-emerald-600 border-2 border-emerald-400 flex items-center justify-center text-white font-black shadow-lg shadow-emerald-900/50"
                        >
                      ...
                      <div
                        class="flex justify-between px-2 text-[8px] font-bold text-gray-600 uppercase tracking-widest mt-2"
                      >
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-8">
                  ...
                  <div class="bg-black/40 p-6 rounded-3xl border border-white/5">
                    <h4 class="text-[10px] font-bold text-gray-500 uppercase tracking-widest mb-4">
                      {{ 'manual.crops.requirements' | transloco }}
                    </h4>
                    <div class="space-y-4">
                      <div class="flex justify-between items-center">
                        ...
                        <div class="flex items-center gap-2">
                          <span class="text-xs font-bold">{{
                            (crop.soilSensitivity > 1.1 ? 'sensitivity.high' : 'sensitivity.moderate') | transloco
                          }}</span>
                          <div
                            class="w-6 h-6 rounded-lg shadow-inner"
                      ...
                      <div class="flex justify-between items-center">
                        ...
                        <div class="flex items-center gap-2">
                          <span class="text-xs font-bold">{{
                            (crop.nutritionSensitivity > 1.1 ? 'sensitivity.high' : 'sensitivity.moderate') | transloco
                          }}</span>
                          <div
                            class="w-6 h-6 rounded-lg shadow-inner"
                  ...
                  <div class="bg-black/40 p-6 rounded-3xl border border-white/5">
                    <h4 class="text-[10px] font-bold text-gray-500 uppercase tracking-widest mb-4">
                      {{ 'manual.crops.weather' | transloco }}
                    </h4>
                    <div class="space-y-3">
                      <div *ngFor="let w of ['drought', 'cold', 'flood']" class="flex justify-between items-center">
                        ...
                        <div class="flex items-center gap-2">
                          <span class="text-xs font-bold">{{
                            'sensitivity.' + getSensitivityKey(crop.weatherSensitivity[w]) | transloco
                          }}</span>
                          <div
                            class="w-6 h-6 rounded-lg shadow-inner"
                  ...
                  <div class="sm:col-span-2 bg-black/40 p-6 rounded-3xl border border-white/5">
                    <h4 class="text-[10px] font-bold text-gray-500 uppercase tracking-widest mb-4">
                      {{ 'manual.crops.yields' | transloco }} (dt/ha)
                    </h4>
                  ...
                  <div class="sm:col-span-2 grid grid-cols-1 sm:grid-cols-2 gap-6">
                    <div class="bg-white/5 p-6 rounded-3xl border border-white/10">
                      <h5 class="text-[10px] font-bold text-emerald-400 uppercase tracking-widest mb-4">
                        {{ 'manual.prices.conv' | transloco }}
                      </h5>
                      <div class="space-y-3">
                        <div class="flex justify-between items-center">
                    ...
                    <div
                      class="bg-emerald-500/10 p-6 rounded-3xl border border-emerald-500/20 shadow-lg shadow-emerald-900/20"
                    >
                      <h5 class="text-[10px] font-bold text-emerald-400 uppercase tracking-widest mb-4">
                        {{ 'manual.prices.org' | transloco }}
                      </h5>
                      <div class="space-y-3">
                        <div class="flex justify-between items-center">
                          <span class="text-sm text-gray-400">{{ 'manual.prices.seed' | transloco }}</span>
                  ...
                  <div
                    *ngIf="crop.special"
                    class="sm:col-span-2 bg-blue-500/10 p-6 rounded-3xl border border-blue-500/20 flex gap-4 items-center"
                  >
  ...
  styles: [
    `
      @media print {
        ...
        nav,
        [class*='bg-gray-900/95'],
        [class*='bg-black/40'],
        [class*='bg-gray-900/90'],
