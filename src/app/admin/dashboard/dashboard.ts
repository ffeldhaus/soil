...
export class Dashboard implements OnInit, OnDestroy {
  t(key: string): string {
    const translations: Record<string, string> = {
      ...
      'dashboard.controls.title': $localize`:@@dashboard.controls.title:Admin-Steuerung`,
      ...
      'dashboard.login.msg': $localize`:@@dashboard.login.msg:Bitte melde dich an, um auf das Admin-Dashboard zuzugreifen.`,
