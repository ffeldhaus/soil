          ...
          <section class="space-y-4 animate-fade-in">
            ...
            >
              ...
              >
                ...
                <div
                  class="space-y-2 text-sm text-gray-300 mb-6 bg-gray-900/50 p-4 rounded-lg border border-gray-700/50"
                >
          ...
          >
            ...
            >
              ...
              <div class="flex gap-3 mt-4">
                ...
                >
                  @if (!isDeleting) {
                    <span>{{ isTrash(gameToDelete) ? 'Permanently Delete' : 'Delete Game' }}</span>
                  }
                  @if (isDeleting) {
