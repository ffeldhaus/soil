...
export const GAME_CONSTANTS = {
  ...
  WEATHER_EFFECTS: {
    ...
    HeatWave: { yield: 0.75, soil: -0.02, name: 'Hitzewelle' },
    Flood: { yield: 0.6, soil: -0.03, name: 'Starkregen/Hochwasser' },
    Storm: { yield: 0.85, soil: -0.01, name: 'Sturm' },
  ...
  CROPS: {
    ...
    Grass: {
      ...
      yields: { veryHigh: '-', high: '-', moderate: '-', low: '-', veryLow: '-' },
      baseYield: 0,
      soilSensitivity: 0,
  ...
  EXPENSES: {
    RUNNING: {
      ORGANIC_CONTROL: 1000, // Annual control fee
      FERTILIZE: 100,
      PESTICIDE: 100,
      ORGANISMS: 150,
      ANIMALS: 250,
